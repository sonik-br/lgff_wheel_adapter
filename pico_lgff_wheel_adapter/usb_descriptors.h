...
//G29 PS3 Mode (not used. output not implemented)
const uint16_t usb_g29_bcd_version = 0x0200;
const char usb_g29_string_product[] = "G29 Driving Force Racing Wheel"; // not sure
const uint16_t usb_g29_bcd_device_version = 0x1350;//not sure
//const uint16_t usb_g29_bcd_device_version = 0x8900;//not sure
//bMaxPacketSize0 64

const uint8_t desc_g29_hid_report[] = {
  0x05, 0x01,        // Usage Page (Generic Desktop Ctrls)
  0x09, 0x04,        // Usage (Joystick)
  0xA1, 0x01,        // Collection (Application)
  0x09, 0x39,        //   Usage (Hat switch)
...
//G923 PS Classic Mode (not used. output not implemented)
const uint16_t usb_g923_bcd_version = 0x0200;
const char usb_g923_string_product[] = "G923 Racing Wheel for PlayStation 4 and PC"; // not sure
const uint16_t usb_g923_bcd_device_version = 0x3800;

const uint8_t desc_g923_hid_report[] = {
  0x05, 0x01,        // Usage Page (Generic Desktop Ctrls)
  0x09, 0x04,        // Usage (Joystick)
  0xA1, 0x01,        // Collection (Application)
  0x09, 0x39,        //   Usage (Hat switch)
